...
class TextBoxPage(BasePage):
    ...
    def fill_all_fields(self):
        ...
        #self.go_to_element(self.locators.SUBMIT).click()
...
class WebTablePage(BasePage):
    ...
    def check_new_added_person(self):
        ...
        for item in people_list:
            data.append(item.text.splitlines())     # splitlines will remove /n from text and split words
        return data
    ...
    def check_search_person(self):
        delete_button = self.element_is_present(self.locators.DELETE_BUTTON)  # find by delete button criteria
        row = delete_button.find_element("xpath", self.locators.ROW_PARENT)   # going up to ancestor element
...
class UploadAndDownloadPage(BasePage):
    ...
    def upload_file(self):
        ...
        os.remove(path)     # this skript will delete a new created file
    ...
    def download_file(self):
        ...
        path_name_file = rf"C:\Users\Sergey\Projects\UI_Automation\files\filetest{random.randint(0, 999)}.jpg"
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_enable_button(self):
        enable_button = self.element_is_clickable(self.locators.ENABLE_AFTER_FIVE_SEC_BUTTON)
        try:
    ...
    def check_apper_of_button(self):
        try:
