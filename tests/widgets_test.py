...
class TestWidgets:
    ...
    class TestAutoCompletePage:
        ...
        def test_remove_value_from_multi(self, driver):
            ...
            assert count_value_before != count_value_after, "The value is incorrect"

        def test_fill_single_autocomplete(self, driver):
            autocomplete_page = AutoCompletePage(driver, "https://demoqa.com/auto-complete")
            autocomplete_page.open()
            color_input = autocomplete_page.fill_input_single()
            color_result = autocomplete_page.check_color_in_single()
            assert color_result == color_input, "The added colors are missing in the input"
    ...
    class TestTabs:
        ...
        def test_tabs(self, driver):
            ...
            assert use_button == 'Use' and use_content != 0, 'the tab "use" was not pressed or text is missing'
    ...
    class TestMenu:
        ...
        def test_menu_items(self, driver):
            ...
            assert data == ['Main Item 1', 'Main Item 2', 'Sub Item', 'Sub Item', 'SUB SUB LIST »', 'Sub Sub Item 1',
                            'Sub Sub Item 2', 'Main Item 3'], 'Menu items do not exits or have not been selected'
