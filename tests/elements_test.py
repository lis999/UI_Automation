...
class TestElements:
    ...
    class TestButtonPage:
        @allure.title("Check different clicks on the button available")
    ...
    class TestLinksPage:
        @allure.title("Check if the link is working and URL is correct")
        ...
        @allure.title("Check the link is broken and error message exists")
    ...
    @allure.feature("UploadAndDownloadPage")
    class TestUploadAndDownloadPage:

        @allure.title("Check a file is uploaded")
        ...
        @allure.title("Check if a file is downloaded")
    ...
    class TestDynamicPropertiesPage:
        ...
        def test_enable_button(self, driver):
            ...
            assert enable is True, "button is not enabled after 5 seconds"
